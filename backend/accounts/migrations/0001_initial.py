    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('team_member', 'Team Member'), ('manager', 'Manager'), ('executive_leader', 'Executive Leader'), ('ai_lead', 'AI Lead')], default='team_member', max_length=20)),
